(function() {
  ...
  const PAGE_REQUEST_EVENT = "stfbot-page-request";
  const PAGE_RESPONSE_EVENT = "stfbot-page-response";
  ...
  async function requestBestMove({ requestId, fen, depth, limitStrength, elo }) {
